...
public class pruebas extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jCheckBox1.setText("Paseo");

        jCheckBox2.setText("Matrimonio");

        jCheckBox3.setText("Gala");

        jCheckBox4.setText("jCheckBox4");

        jLabel1.setText("Imagen Paseo");

        jLabel2.setText("Imagen matrimonio");

        jLabel3.setText("Imagen Gala");

        jLabel4.setText("Imagen fiesta empresas");
        ...
        jTabbedPane1.addTab("Menú", jPanel4);
